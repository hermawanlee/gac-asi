    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('community/revtambah'); ?>">
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('community/revhapus'); ?>">
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">Menu</label>
                                <div class="col-md-6">
                                    <div class="form-group has-default">
                                        <select class="selectpicker" name="nama" data-style="select-with-transition" data-size="7" required>
                                            <?php
                                            $menu = $this->db->get('jumlah_member')->result_array();
                                            foreach ($menu as $m) : ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <form class="form" method="post" action="<?= base_url('community/revedit'); ?>">
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">Menu</label>
            ...
            <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label">Maintain</label>
                            <div class="col-md-9">
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label">Role (Hanya untuk menu FIDA)</label>
                            <div class="col-md-9">
