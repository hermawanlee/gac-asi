...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('<?= base_url(); ?>assets/img/logoprimary.png'); background-size: cover; background-position: top center;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form class="form" method="post" action="<?= base_url('auth/login'); ?>">
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  <p class="card-description text-center">Masukan ID Cach dan Passsword</p>
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="id" placeholder="GACxxxxxx">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
          ...
          <!-- <i class="material-icons">perm_phone_msg</i> -->
            Butuh bantuan ? Hubungi <a href="https://wa.me/62822-8210-7470?text=Tanya%20tentang%20FIDA?" target="blank">FIDA</a> (+62822-8210-7470)
            <br/>atau <a href="https://wa.me/62822-8210-7470" target="blank">GAC</a> (+62822-8210-7470)
          </div>
        </div>
      </div>
      <footer class="footer">
